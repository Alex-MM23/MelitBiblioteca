...
public class LibrosTestSamples {
    ...
    public static Libros getLibrosSample1() {
        return new Libros().id(1L).isbn(1).stock(1).autor("autor1").imagen("imagen1").paginas(1).titulo("titulo1").numeroAlquilados(1);
    }

    public static Libros getLibrosSample2() {
        return new Libros().id(2L).isbn(2).stock(2).autor("autor2").imagen("imagen2").paginas(2).titulo("titulo2").numeroAlquilados(2);
    }
