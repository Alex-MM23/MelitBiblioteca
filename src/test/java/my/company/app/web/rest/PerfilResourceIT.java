...
import static my.company.app.domain.PerfilAsserts.*;
...
import my.company.app.repository.PerfilRepository;
...
class PerfilResourceIT {
    ...
    public static Perfil createEntity(EntityManager em) {
        Perfil perfil = new Perfil().admin(DEFAULT_ADMIN).usuario(DEFAULT_USUARIO);
        return perfil;
    }
    ...
    public static Perfil createUpdatedEntity(EntityManager em) {
        Perfil perfil = new Perfil().admin(UPDATED_ADMIN).usuario(UPDATED_USUARIO);
        return perfil;
    }
    ...
    void putExistingPerfil() throws Exception {
        ...
        updatedPerfil.admin(UPDATED_ADMIN).usuario(UPDATED_USUARIO);
    ...
    void partialUpdatePerfilWithPatch() throws Exception {
        ...
        partialUpdatedPerfil.admin(UPDATED_ADMIN).usuario(UPDATED_USUARIO);
