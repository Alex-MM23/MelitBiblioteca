...
class LibrosResourceIT {
    ...
    private static final Integer DEFAULT_ID_TEMATICA = 1;
    private static final Integer UPDATED_ID_TEMATICA = 2;
    ...
    public static Libros createEntity(EntityManager em) {
        Libros libros = new Libros()
            ...
            .idTematica(DEFAULT_ID_TEMATICA);
        return libros;
    }
    ...
    public static Libros createUpdatedEntity(EntityManager em) {
        Libros libros = new Libros()
            ...
            .idTematica(UPDATED_ID_TEMATICA);
        return libros;
    }
    ...
    void getAllLibros() throws Exception {
        ...
        restLibrosMockMvc
            ...
            .andExpect(jsonPath("$.[*].idTematica").value(hasItem(DEFAULT_ID_TEMATICA)));
    }
    ...
    void getLibros() throws Exception {
        ...
        restLibrosMockMvc
            ...
            .andExpect(jsonPath("$.idTematica").value(DEFAULT_ID_TEMATICA));
    }
    ...
    void partialUpdateLibrosWithPatch() throws Exception {
        ...
        partialUpdatedLibros.isbn(UPDATED_ISBN).autor(UPDATED_AUTOR).paginas(UPDATED_PAGINAS);
