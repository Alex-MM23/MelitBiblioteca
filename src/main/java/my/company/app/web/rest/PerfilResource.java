...
/**
 * REST controller for managing {@link my.company.app.domain.Perfil}.
 */
@RestController
...
public class PerfilResource {
    ...
    public ResponseEntity<Perfil> partialUpdatePerfil(
        ...
        Optional<Perfil> result = perfilRepository
            ...
            .map(existingPerfil -> {
                if (perfil.getAdmin() != null) {
                    existingPerfil.setAdmin(perfil.getAdmin());
                }
                if (perfil.getUsuario() != null) {
                    existingPerfil.setUsuario(perfil.getUsuario());
                }
